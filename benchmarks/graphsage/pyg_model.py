...
class PyGGraphSAGE(nn.Module):
    def __init__(
        ...
        self._layers.append(SAGEConv(in_feats, hidden_feats))

        for i in range(1, num_layers - 1):
            self._layers.append(SAGEConv(hidden_feats, hidden_feats))

        self._layers.append(SAGEConv(hidden_feats, out_feats))
